...
static source_runtime_t source_runtime[RELAY_RULE_MAX_SOURCES];
static rule_runtime_t rule_runtime[RELAY_RULE_MAX_RULES];
...
{
    memset(source_runtime, 0, sizeof(source_runtime));
    memset(rule_runtime, 0, sizeof(rule_runtime));
}
